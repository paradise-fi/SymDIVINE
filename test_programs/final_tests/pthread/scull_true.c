...
volatile int scull_quantum = SCULL_QUANTUM;
volatile int scull_qset = SCULL_QSET;
volatile int dev_data;
volatile int dev_quantum;
volatile int dev_qset;
volatile unsigned_long dev_size; 
volatile int __X__; //variable to test mutual exclusion 
